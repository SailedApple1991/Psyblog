...
export async function loader({ params }: LoaderArgs) {
  ...
  const response = await fetch(
    `${process.env.STRAPI_URL_BASE}/api/carousels?populate=Image&locale=${locale}`,
    {
      method: "GET",
      headers: {
            ...
            >
              ...
              >
                ...
                <img
                  ...
                  src={
                    "http://localhost:1337" +
                    carousel.attributes.Image.data.attributes.formats.small.url
                  }
